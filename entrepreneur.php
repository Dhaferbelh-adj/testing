...
if(mysql_num_rows($resultat)==1){
  ...
  .centered-block:hover {
    ...
    <meta http-equiv="refresh" content="100;url=connexion (1).html">  </head>
  <body>
  
  <div class="centered-block"><h1></h1><img src="oops.PNG">
  ...
  <div class="centered-block"><h1></h1><img src="success.PNG">
    <p>Vous allez être redirigé vers la page de connexion dans 5 secondes.</p>
